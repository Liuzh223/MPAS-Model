...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!cye
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    SR_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    SB_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    SG_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    RR_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    RB_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    RG_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    HR_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    HB_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    HG_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    ELER_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    ELEB_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    ELEG_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    G0R_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    G0B_URB2D
     real(kind=kind_noahmp), allocatable, dimension(:)      ::    G0G_URB2D  
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!cye
